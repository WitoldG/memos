...
## rebase --onto
se mettre sur la branche qu'on veut rebase `git rebase <sha_1er_commit_quon_veut_pas_prendre> --onto <branche_dest>`
...
# Stash
Specific files: `git stash push <path1> <path2>`
With a message: `git stash push -m "name"`
